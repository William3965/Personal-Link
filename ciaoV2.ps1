...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('iknowanddontknow@gmail.com', 'Playjustforfun') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'iknowanddontknow@gmail.com' #Email in which you want to receice the information
$ReportEmail.To.Add('iknowanddontknow@gmail.com') #Email in which you want to receive the information
